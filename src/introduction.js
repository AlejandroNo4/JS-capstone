export class Introduction extends Phaser.Scene {
  ...
  preload() {
    this.load.image("map-atlas", "./assets/images/map/terrain-atlas.png");
    this.load.tilemapTiledJSON("map", "./assets/images/map/map.json");

    // this.load.spritesheet("enemy", "./assets/images/characters/enemy.png", {
    //   frameHeight: 110,
    //   frameWidth: 89,
    // })
  ...
  create() {
    ...
    const ground = map.createLayer("ground", tilesetTerrain, 0, 0);
    ...
    // this.enemy = this.physics.add.sprite(100, 1000, "enemy", 0);
